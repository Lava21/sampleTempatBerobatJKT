...
public class RSKhususAdapter extends RecyclerView.Adapter<RumahSakitHolder> {
    public List<RumahSakitModel> rumahSakitModelList;
    private RSKhususAdapter.onSelectData onSelectData;
    ...
    public RSKhususAdapter(Context mContext, List<RumahSakitModel> rumahSakitModelList, RSKhususAdapter.onSelectData xSelectData) {
    ...
    public RumahSakitHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_rs_khusus, parent, false);
